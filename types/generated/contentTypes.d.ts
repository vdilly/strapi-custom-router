...
export interface ApiDossierDossier extends Struct.CollectionTypeSchema {
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['page', 'section']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'page'>;
    fullpath: Schema.Attribute.String & Schema.Attribute.Unique;
